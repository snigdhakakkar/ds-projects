...
shahrukh_image = face_recognition.load_image_file("Shahrukh/shahrukh.jpeg")
...
# Load a second sample picture and learn how to recognize it.
morgan_image = face_recognition.load_image_file("Morgan/morgan-freeman.jpeg")
morgan_face_encoding = face_recognition.face_encodings(morgan_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    shahrukh_face_encoding,
    bradley_face_encoding,
    morgan_face_encoding
]
known_face_names = [
    "Shahrukh",
    "Bradley",
